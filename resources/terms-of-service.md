...
Welcome to https://www.idriss.xyz, a website (“Site”) provided by IDRISS DAO LLC (“IDRISS”, “We”, “Our”, or “Us” as well as “we”, “our” or “us”), a company incorporated with limited liability in the Republic of Marshall Island, with registered office in PO Box 852, Long Island Rd, Majuro, Marshall Islands MH 96960.

This Site is provided to you (“You” or “Your” or “User” as well as “you” or “your” or “user”), subject to the following Terms & Conditions (“Terms”), as modified and updated from time to time. IDRISS and You, collectively referred to as “the Parties” or “Parties”.

Please note that while every product or service offered or commercialized through this Site (even if not exclusively) is subject and is regulated by these Terms, some of these products or services may have additional terms and conditions which may regulate Your use of those services or products. In the case of the conflict between these Terms and the specific terms and conditions of a product or service the latter will prevail. If a product or a service offered or commercialized through this Site does not have its own specific terms and conditions, only these Terms will be applicable to such a product or a service.&#x20;

The Terms and Conditions located at [https://www.idriss.xyz/tac](http://www.idriss.xyz/tac) govern and regulate the purchase, receipt, and use of the IDRISS token (“Token TaC). The Token TaC apply irrespective of whether the Token is acquired through purchase on the primary market, purchase on the secondary market, receipt via airdrop, as compensation for services rendered, as a gift, or through any other means. By acquiring or accepting the Token, you acknowledge that you have read, understood, and agree to be bound by the Token TaC. Should you disagree with any part of the Token TaC, you are advised not to purchase, accept, or otherwise engage with the Token.

1\. Acceptance and updates

These Terms and the [Privacy Policy](https://www.idriss.xyz/pp) (“Privacy Policy”) govern your use of our Site as well as of any product or services offered or sold (even if not exclusively) through this Site, where additional terms and conditions for products and services sold through this Site may also apply to those products and services. To use this Site and purchase any product or services offered or sold (even if not exclusively) through this Site, you must be able to form a legally binding contract online either as an individual or on behalf of a legal entity. To that end, you represent that: (a) if you are agreeing to these Terms on behalf of a legal entity, you have the legal authority to bind the legal entity to these Terms; and (b) if you are agreeing to these Terms as a natural person You are at least 18 years old or the age of majority where you reside, whichever is older, and that You can form a legally binding contract online. Persons younger than the age of 18 are considered minors and must be under the care of a parent or guardian unless they are emancipated. &#x20;
...
Please read carefully our [Privacy Policy](https://www.idriss.xyz/pp) which is a part of these Terms.
...
By accessing our Site or purchasing any product or services offered or sold (even if not exclusively) through this Site, you warrant that You:
...
* will use our Site or our product and service only as explicitly authorized and in compliance with these Terms and our policies made available to you;
...
Certain digital assets or tokens available through IDRISS may be restricted or regulated by jurisdiction. IDRISS does not provide legal, financial, or tax advice and does not determine which tokens are permitted or prohibited in any country or region. Creators, viewers, donors, and other users are solely responsible for verifying whether enabling, receiving, sending, or holding any token complies with the laws applicable to them (including restrictions on U.S. persons, where relevant). The dashboard may allow you to enable or disable specific tokens; any such selection is your decision and at your sole risk. By enabling a token, you represent that you are legally permitted to use it and will comply with all applicable laws. IDRISS provides only technical access and assumes no responsibility for any compliance, registration, or reporting obligations, and disclaims liability arising from your token selections or transactions.

IDRISS allows users to upload custom assets, such as sound alerts, to personalize their stream experience. By uploading content, you confirm that you either own or have the full legal rights, licenses, and permissions to upload, use, and publish that content. You agree not to upload content that is unlawful, infringing, harassing, defamatory, obscene, or otherwise objectionable. You grant IDRISS a non-exclusive, royalty-free, worldwide license to store, display, reproduce, and distribute this content as needed to operate the platform. While IDRISS does not monitor uploads in real time, we reserve the right to remove or restrict access to any content that violates these Terms, applicable laws, or our community guidelines.
...
Using IDRISS does not guarantee any level of revenue, earnings, or donation activity. Your results depend entirely on your own use of the platform, audience engagement, and external factors beyond our control.

5\. Blockchain and crypto assets

The Site nor IDRISS is a broker or intermediary and is in no way your agent, advisor, or custodian, and we do not have a fiduciary relationship or obligation to you regarding any other decisions or activities that you effect when using your wallet to interact with any blockchain protocol. Nothing included in the Site constitutes an offer or solicitation to sell, or distribution of, investments and related services to anyone in any jurisdiction.
...
IDRISS does not warrant that the Site service will be uninterrupted or error free or that any information, software or other material available on or accessible through the Web site is free of viruses, worms, Trojan horses or other harmful components (see also below clause 8).
...
Use of blockchain protocol networks are typically subject to third-party transaction fees. Any interaction with a blockchain protocol network is a locally run instance and, as a result, IDRISS has no knowledge of such interactions, does not receive such fees, and has no ability to reverse or refund any amounts paid in error to initiate any transaction.

10\. Copyright and Trademarks

All content on our Site or in our product or services is protected by copyright and owned by IDRISS.

Unless otherwise specified like in paragraph 3 of this Article 9, you cannot reproduce the Site or parts of it.

IDRISS retains all rights in its name, logos and trademarks (“Trademarks”), whether or not registered. You may not use our Trademarks without our prior written permission and in any manner that is likely to cause confusion about whether we are the source of or sponsor of or endorser of a product, service, or activity.  If you wish to use one of our Trademarks, please contact  [hello@idriss.xyz](mailto:hello@idriss.xyz) to request permission.  All other Trademarks displayed on our Site are the property of their respective owners.
...
Please also note that the IDRISS browser extension facilitates access to services and content provided by third parties via APIs and decentralized smart contracts. We are not liable for any actions taken within these third-party integrations nor for the content provided through them and if you decide to access or use those third-party services or content you do it at your own risk. Access to these integrations requires you to adhere to the terms of service and privacy policies of any third-party services you use through our platform, in addition to the conditions listed below.&#x20;

11.1 Agora, Gicoin, Snapshot, Tally
...
11.3 Trading Copilot

By using the Trading Copilot feature, you acknowledge and accept that all trades executed through this tool are conducted entirely at your own discretion and risk. Cryptocurrency trading is inherently volatile and involves the potential loss of all invested funds. IDRISS does not offer financial, legal, or investment advice and disclaims any liability for financial losses or damages incurred through Trading Copilot. This tool integrates with third-party APIs and decentralized smart contracts to provide services; however, IDRISS makes no guarantees regarding the accuracy, reliability, or timeliness of data received from third-party sources or integrations. Use of these third-party services is subject to their respective terms, and any risks arising from these interactions are solely your responsibility. IDRISS is not responsible for any losses, breaches, or hacks that may occur due to your use of Trading Copilot on unsafe or malicious websites. Before connecting, you should verify the legitimacy and security of any platform you use Trading Copilot on. Users are strongly advised to remain vigilant and research platforms thoroughly. IDRISS bears no responsibility for unauthorized transactions or any other actions resulting from interactions on unsafe platforms. You are also responsible for complying with all applicable laws, regulations, and tax obligations in your jurisdiction. By accessing or using Trading Copilot, you agree to indemnify and hold IDRISS harmless from any claims or liabilities arising from your use of the feature. If you do not agree to these conditions, you must immediately cease using Trading Copilot.
...
13\. Rewards and Incentive Programs
